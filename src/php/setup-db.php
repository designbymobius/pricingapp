<?php
	...
	// required vars
		...
		$retail_price_column = DB_RETAIL_PRICE_COLUMN;
		$wholesale_price_column = DB_WHOLESALE_PRICE_COLUMN;
	...
	// product table
		$create_product_table = create_table(
			...
			"(
				...
				$retail_price_column . " varchar (250)," .
				$wholesale_price_column . " varchar (250)
			)"
		);
